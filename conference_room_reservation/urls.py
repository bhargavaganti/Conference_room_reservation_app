...
urlpatterns = [
    ...
    re_path(r'^room/new/(?P<room>(\d)+)(?P<date>/(\d{2}-\d{2}-\d{4})+)$', RoomCreateView.as_view(), name='room-create-view'),
    ...
    re_path(r'^search_room/$', RoomSearchView.as_view(), name='room-search-view'),
